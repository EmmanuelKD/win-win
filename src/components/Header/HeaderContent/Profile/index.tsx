...
// assets
import { LockFilled, LogoutOutlined, UserOutlined } from "@ant-design/icons";
...
// tab panel wrapper
function TabPanel({ children, value, index, ...other }: TabPanelPropTypes) {
  return (
    <div
      role="tabpanel"
      hidden={value !== index}
...
const Profile = ({ autContext }: { autContext: AuthContextType }) => {
